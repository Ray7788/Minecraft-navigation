...
class DeltaInventoryWrapper(gym.Wrapper):
    """
    This wrapper adds a delta inventory observation to the original observation.
    The delta inventory observation is a dictionary with the following keys:
        - inc_name_by_craft: the names of the items that are increased by the crafting action
        - inc_quantity_by_craft: the quantities of the items that are increased by the crafting action
        - dec_name_by_craft: the names of the items that are decreased by the crafting action
        - dec_quantity_by_craft: the quantities of the items that are decreased by the crafting action
        - inc_name_by_other: the names of the items that are increased by other actions
        - inc_quantity_by_other: the quantities of the items that are increased by other actions
        - dec_name_by_other: the names of the items that are decreased by other actions
        - dec_quantity_by_other: the quantities of the items that are decreased by other actions
    """
    def __init__(
        self,
