...
class POVObservation(KeymapTranslationHandler):
    ...
    def __repr__(self):
        ...
        # "POVObservation(video_resolution={self.video_resolution}, include_depth={self.include_depth}):rgb"
        return result
...
# TODO: check order of video_resolution
    ...
    def from_hero(self, obs):
        """
        Returns the POV observation from the hero observation.
        """
