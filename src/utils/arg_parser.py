...
# clip model
        parser.add_argument(
            '--clip-config-path',
            type=str,
            help="specify the path of clip config",
        ...
        parser.add_argument(
            '--clip-model-path',
            type=str,
            help="specify the path of clip model",
        ...
        parser.add_argument(
            '--skills-model-config-path',
            help="specify the path of skills model config",
            type=str,
            default='skills/load_skills.yaml'
        )
...
# save results
        ...
        parser.add_argument(
            '--progressive_search',
            help="choose 1 if use progressive search",
            type=int,
            default=1
        )
