...
LABEL maintainer "https://github.com/ehfd,https://github.com/danisla,https://github.com/Ray7788"
...
# Clean cache, update apt list, clean apt list and generate en_US.UTF-8 locale.
RUN apt-get clean && \
...
# Install VirtualGL, directly use GitHub release to avoid 404 error
